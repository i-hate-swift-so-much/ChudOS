...
extern "C" void HandlePageFault(RegistersKernelError* regs){
    ...
    afstd::int_to_char_array_hex(Page, VirtualAddress, sizeof(VirtualAddress));
    afstd::printf("\n");
    char PhysicalAddress[22];
    afstd::int_to_char_array_hex(parsed.physical_address, PhysicalAddress, sizeof(PhysicalAddress));
    afstd::printf("\n");
    char Flags[22];
    afstd::int_to_char_array_binary(parsed.flags.flags, Flags, sizeof(Flags));
    afstd::printf("\n");
    char Err_str[22];
    afstd::int_to_char_array_binary(err, Err_str, sizeof(Err_str));
    afstd::printf("\n");
    ...
    WriteString("Error Code       :", 1, 16);
    WriteString(Err_str, 30, 16);
...
extern "C" void GeneralProtectionFault(RegistersKernelError* regs){
    ...
    afstd::int_to_char_array(err, index_string, sizeof(index_string));
